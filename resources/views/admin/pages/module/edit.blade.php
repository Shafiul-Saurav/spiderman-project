        ...
        <div class="col-xl">
            <div class="card mb-4">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="mb-0 text-primary">Module Edit Form</h5>
                    <a href="{{ route('module.index') }}" class="btn btn-info"><i class='bx bx-chevrons-left'></i> Index</a>
                </div>
                <div class="card-body">
                    <form action="{{ route('module.update', $module->module_slug) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            ...
                            <div class="input-group input-group-merge">
                                ...
                                @error('module_name')
                                    is-invalid
                                @enderror"
                                    value="{{ $module->module_name }}" placeholder="Enter Module Name">
                                @error('module_name')
