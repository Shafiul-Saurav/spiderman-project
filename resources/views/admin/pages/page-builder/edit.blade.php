    ...
    <div class="row">
        <div class="col-xl">
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <form action="{{ route('page.update', $page->page_slug) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-3">
                            <label for="page_image" class="form-label">Page Image</label>
                            <input type="file" name="page_image" class="form-control dropify"
                            data-default-file="{{ asset('uploads/page_images') }}/{{ $page->page_image }}">
                            @error('page_image')
                        ...
                        <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        @error('page_title')
                                            is-invalid
                                        @enderror"
                                            value="{{ $page->page_title }}" placeholder="Enter Page Title">
                                        @error('page_title')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        @error('page_slug')
                                            is-invalid
                                        @enderror"
                                            value="{{ $page->page_slug }}" placeholder="Enter Page Slug">
                                        @error('page_slug')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        @error('meta_title')
                                            is-invalid
                                        @enderror"
                                            value="{{ $page->meta_title }}" placeholder="Enter Meta Title">
                                        @error('meta_title')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        ...
                                        @error('meta_keywords')
                                            is-invalid
                                        @enderror"
                                            value="{{ $page->meta_keywords }}" placeholder="Enter Meta Keywords">
                                        @error('meta_keywords')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="page_short" id="page_short" cols="30" rows="5" class="form-control">{{ $page->page_short }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    <label for="page_long" class="form-label">Long Description</label>
                                    <textarea name="page_long" id="page_long" cols="30" rows="5" class="form-control">{{ $page->page_long }}</textarea>
                                </div>
                            </div>
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <textarea name="meta_description" id="meta_description" cols="30" rows="5" class="form-control @error('meta_description')
                                        is-invalid
                                    @enderror">{{ $page->meta_description }}</textarea>
